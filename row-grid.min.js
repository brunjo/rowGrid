...
void 0===a.lastRowClass&&(a.lastRowClass="last-row")):a=JSON.parse(f.getAttribute("data-row-grid")),n(f,a),f.setAttribute("data-row-grid",JSON.stringify(a)),a.resize&&window.addEventListener("resize",function(u){n(f,a)})};
